...
- Frontend container build file: [frontend/Dockerfile.aws](../../frontend/Dockerfile.aws)
- Frontend Nginx SPA config: [frontend/nginx.aws.conf](../../frontend/nginx.aws.conf)
- Frontend env template: [frontend/.env.aws.example](../../frontend/.env.aws.example)
- Backend env template: [Hackathon/backend/.env.aws.example](../../Hackathon/backend/.env.aws.example)
- Backend container file: [Hackathon/Dockerfile](../../Hackathon/Dockerfile)
...
3. Add env vars from [Hackathon/backend/.env.aws.example](../../Hackathon/backend/.env.aws.example).
...
Set backend `CORS_ORIGINS` to include your Amplify domain and any custom frontend domain.
...
Create `.env` from [Hackathon/backend/.env.aws.example](../../Hackathon/backend/.env.aws.example), then run:
