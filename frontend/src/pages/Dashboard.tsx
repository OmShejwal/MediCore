import { Activity, Heart, Flame, Moon, Plus } from "lucide-react";
    ...
    <div className="p-4 md:p-8 space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Button variant="outline" className="rounded-xl border-border/50 bg-background/50 backdrop-blur-sm">
            Download Report
          </Button>
          <Button className="rounded-xl gradient-primary shadow-lg shadow-primary/20">
